...
public class BlackjackController {
    ...
    public StartGameResponse startGame(
        ...
        String gameId = blackjackService.startGame(
                principal.getName(),
                request.getBet()
        );
    ...
    public GameResponse hit(@PathVariable String gameId) {
        return blackjackService.hit(gameId);
    }

    @PostMapping("/{gameId}/stand")
    public GameResponse stand(@PathVariable String gameId) {
    ...
    @GetMapping("/history")
    public List<GameHistoryEntry> getHistory(Principal principal) {
        return blackjackService.getHistory(principal.getName());
    }
}